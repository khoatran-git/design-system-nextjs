...
export function getCacheConfig(contentType) {
  const config = {
    components: CACHE_CONFIG.MEDIUM,      // Components change frequently during dev
    foundations: CACHE_CONFIG.LONG,        // Foundations are stable
    resources: CACHE_CONFIG.LONG,          // Resources are stable
    detail: CACHE_CONFIG.SHORT,            // Detailed pages refresh more often
    search: CACHE_CONFIG.SHORT,            // Search results should be fresh
  }

  return config[contentType] || CACHE_CONFIG.MEDIUM
}
